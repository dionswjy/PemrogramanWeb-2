    ...
    <div class="flex justify-between items-center mb-4">
        ...
        <div>
            <flux:button icon="plus">
                <flux:link href="{{ route('dashboard.categories.create') }}" variant="subtle">Add New Category
                </flux:link>
            </flux:button>
        </div>
    </div>
                    ...
                    <tr>
                        ...
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">
                                ...
                                @else
                                    <div class="h-10 w-10 bg-gray-200 flex items-center justify-center rounded"><span
                                            class="text-gray-500 text-sm">N/A</span>
                                    </div>
                                @endif
                            </p>
                        </td>
                        ...
                        <td>
                            <form id="sync-category-{{ $category->id }}"
                                action="{{ route('dashboard.category.sync', $category->id) }}" method="POST">
                                @csrf
                            ...
                            <flux:dropdown>
                                ...
                                <flux:menu>
                                    <flux:menu.item icon="pencil"
                                        href="{{route('dashboard.categories.edit', $category->id) }}">Edit</flux:menu.item>
