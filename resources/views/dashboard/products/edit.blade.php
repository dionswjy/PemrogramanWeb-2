<x-layouts.app :title="__('Edit Product')">
    ...
    <form action="{{ route('dashboard.products.update', $product->id) }}" method="post" enctype="multipart/form-data">
        ...
        <flux:input label="SKU" name="sku" class="mb-3" placeholder="Stock Keeping Unit"
        ...
        <div class="mb-3">
            ...
            <input type="file" name="image" id="image"
                class="mt-1 block w-full text-sm text-gray-500 file:py-2 file:px-4 file:border file:border-gray-300 file:rounded-md" />
